          ...
          <div class="card bg-dark">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-light text-uppercase ls-1 mb-1">Ringkasan Penjualan</h6>
                  <h5 class="h3 text-white mb-0">Ringkasan Penjualan 2022</h5>
        ...
        <div class="col-xl-4">
          <div class="card bg-dark">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1 text-white">Ringkasan</h6>
                  <h5 class="h3 mb-0 text-white">Pendapatan</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header bg-dark">
              <!-- Title -->
              <h5 class="h3 mb-0 text-white">Pelanggan baru</h5>
            </div>
            <!-- Card body -->
              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0 bg-dark">
                  <div class="row align-items-center bg-dark">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/uploads/users/'. $customer->profile_picture); ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0 text-white">
                        <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>"><?php echo $customer->name; ?></a>
                      </h4>
                      
                    </div>
                    <div class="col-auto">
                      <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>" class="btn btn-sm btn-white text-dark">Profil</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header bg-dark">
              <!-- Title -->
              <h5 class="h3 mb-0 text-white">Order baru</h5>
            </div>
            <!-- Card body -->
            <div class="card-body p-0">
              ...
              <ul class="list-group list-group-flush" data-toggle="checklist">
                ...
                <li class="checklist-entry list-group-item flex-column align-items-start py-4 px-4 bg-dark">
                  <div class="checklist-item checklist-item-info bg-dark">
                    <div class="checklist-info bg-dark text-white">
                      <h5 class="checklist-title mb-0 text-white"><?php echo anchor('admin/orders/view/'. $order->id, 'Order #'. $order->order_number); ?></h5>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header bg-dark">
              <!-- Title -->
              <h5 class="h3 mb-0 text-white">Pembayaran menunggu konfirmasi</h5>
            </div>
            <!-- Card body -->
            <div class="card-body bg-dark">
              <!-- List group -->
              ...
              <?php foreach ($payments as $payment) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="<?php echo site_url('admin/payments/view/'. $payment->id); ?>" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/uploads/user/'. $payment->profile_picture); ?>">
                      </a>
                    </div>
                    <div class="col">
        ...
        <div class="col-xl-8">
          <div class="card bg-dark">
            <div class="card-header border-0 bg-dark">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0 text-white">Produk baru</h3>
                </div>
        ...
        <div class="col-xl-4">
          <div class="card bg-dark">
            <div class="card-header border-0 bg-dark">
              <div class="row align-items-center bg-dark">
                <div class="col">
                  <h3 class="mb-0 text-white">Kategori produk</h3>
                </div>
                <div class="col text-right">
