...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="<?php echo get_theme_uri('img/brand/logo-betta.png', 'argon'); ?>" type="image/png">
  <!-- Fonts -->
...
<body class="@yield('sidebar_type')">
  <!-- Sidenav -->
  <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-sm navbar-dark bg-dark" id="sidenav-main">
