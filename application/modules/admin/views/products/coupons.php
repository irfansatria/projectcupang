        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" data-target="#addModal" data-toggle="modal" class="btn btn-sm btn-primary">Tambah</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0 bg-primary">
              <h3 class="mb-0 text-white">Kategori Kupon</h3>
            </div>
          ...
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-primary">
                      <h3 class="card-heading text-center mt-2 text-white">Edit Kupon</h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
  ...
  $(document).ready(function() {
    ...
    var table = $('#packageList').DataTable({
      ...
      "language" : {
        ...
        "infoEmpty" : "Tidak ada hasil pencarian ditemukan",
