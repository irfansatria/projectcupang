...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/uploads/sites/logo-betta.png'); ?>">
...
<body class="goto-here">
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						...
						<div class="col-md pr-4 d-flex topper align-items-center">
							...
							<span class="text">bettafishstore@gmail.com</span>
						</div>
						<div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
							<span class="text">Beli Ikan Cupang?? BettaFish Store aja !!</span>
						</div>
					</div>
				</div>
			</div>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-info fixed" id="ftco-navbar">
		<div class="container">
			<img src="<?php echo base_url('assets/uploads/sites/logo-betta.png'); ?>" id="gambars">
			<a class="navbar-brand" href="<?php echo base_url(); ?>">BettaFish Store</a>
