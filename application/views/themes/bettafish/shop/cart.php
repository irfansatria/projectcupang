...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/p-multi.png'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php if ( count($carts) > 0) : ?>
            <form action="<?php echo site_url('shop/checkout'); ?>" method="POST">
              ...
              <div class="col-md-12 ftco-animate">
                  <div class="cart-list">
                      <table class="table">
                          <thead style="background-color: lightblue;" style="color: white;">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><?php echo anchor('home', 'Jelajahi produk kami'); ?> dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
